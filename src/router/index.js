...
export const DEFAULT_DESC = 'REISTI 公式サイト。台湾で約30年の実績を持つ母体企業から生まれた工具ブランド。充電マルチドリルビット・コバルトドリル・ハイス／超硬ホールソーを自社製造。OEMも対応。'
...
export const routes = [
  ...
  { path: '/about',                    name: 'about',    component: AboutView,
    meta: { title: '会社概要｜REISTI', desc: '瑞士釘株式会社（REISTI）の会社概要。台湾で約30年、金物・工具卸売業界を牽引してきた瑞士釘を母体に、2025年日本で設立された工具ブランドです。' } },
